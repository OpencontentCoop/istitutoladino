...
{foreach $block_wrappers as $index => $block_wrapper}  
  ...
  {else}
    <div class="block-wrapper {if $block_wrapper.has_style}u-background-grey-20 u-padding-r-top u-padding-r-bottom{/if}" id="{$block_wrapper.slug}">
      <section {if is_set(ezpagedata().persistent_variable.has_container)}class="u-layout-wide u-layoutCenter u-layout-r-withGutter"{/if}>
